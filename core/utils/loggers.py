...
# 파일 핸들러 설정
file_handler = logging.FileHandler(f"/home/kbk/logs/py/element_finder_{formatted_now}.log")
...
log_directory = "/home/kbk/logs/py/"
log_file_pattern = os.path.join(log_directory, "element_finder_*.log")
...
# 로그 파일 수 제한 함수 호출
limit_log_files(log_directory, log_file_pattern)
